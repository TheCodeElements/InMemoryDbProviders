    ...
    override fun createInDatabase() {
        val sqlCreateTable =
            (" CREATE TABLE " + tableName +
                    ...
                    " var_name TEXT(256) UNIQUE NOT NULL," +
...
//            uriCode_Table_Values -> PROVIDER_NAME + "//" + TABLE_NAME_VALUES.lowercase()
//            uriCode_Table_Debug -> PROVIDER_NAME + "//" + TABLE_NAME_DEBUG.lowercase()
...
//        }
    ...
    override fun insert(uri: Uri, values: ContentValues?): Uri {
        ...
        if (rowID > 0) {
            val uriWithRowId = ContentUris.withAppendedId(tables[code - 1].CONTENT_URI, rowID)
